...
export default function SpotifySearch ({
  ...
  return (
    <motion.div
      ...
      className='w-full h-full p-5 rounded-b-2xl flex flex-col flex-wrap items-center justify-center overflow-x-hidden'
    >
      <input
        style={{
        ...
        className='my-2 px-2 md:px-4 rounded-2xl w-full text-2xl placeholder-black'
